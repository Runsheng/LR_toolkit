...
# ('I', '694217', '694228', 'GCTGGNCTATG', 'GCTGGTCTATG')==chr,start,end,seq_raw,seq_new, seperated by \t
...
def sequence_replace(record_dict, N_replace=read_nreplace(n_text_filename="N_text.txt"),outfile="replaced.fasta" ):
    """
